    ...
    <section id="story" className="relative py-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-6 text-brand-text leading-relaxed">
              ...
              <p>
                The octopus isn&apos;t just a logo. It&apos;s the metaphor that drove the architecture: tentacles reaching across all your accounts simultaneously, managing everything in parallel, while you stay focused on what matters — your edge.
              </p>
          ...
          <div className="space-y-6">
            {[
              ...
              <div
                key={i}
                className={`flex gap-4 p-5 rounded-xl border ${item.color} transition-all duration-300 hover:scale-[1.02]`}
              >
                ...
                <div>
                  ...
                  <div className="text-base font-bold text-brand-heading mb-1">{item.title}</div>
                  <div className="text-sm text-brand-text">{item.desc}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="mt-16 max-w-3xl mx-auto text-center">
          ...
          <blockquote className="text-xl sm:text-2xl font-medium text-brand-heading italic leading-relaxed">
          ...
          <div className="mt-6 text-brand-text text-sm">
