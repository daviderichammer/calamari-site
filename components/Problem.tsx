      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-brand-text max-w-2xl mx-auto px-2">
            You know how to trade. But you&apos;re spending more time managing infrastructure than actually trading. That&apos;s backwards.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "MT4/MT5 goes down. Your position stays open. You find out in the morning when the damage is already done.",
            },
            {
              icon: "🔄",
            ...
            },
            {
              icon: "🖥️",
              title: "RDP hell",
              desc: "Multiple separate VPS connections. Multiple Windows environments. Checking each one individually, every single day.",
            },
            {
              icon: "💸",
              title: "VPS costs stacking up",
              desc: "Paying $20–50/month per VPS, then spending hours setting up MT4/MT5 on each one. The DIY tax is real.",
            },
            {
              icon: "🌐",
