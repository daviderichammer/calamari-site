  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Main glow */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-brand-blue/20 rounded-full blur-[120px] animate-pulse-glow" />
        <div className="absolute top-1/3 left-1/4 w-[400px] h-[400px] bg-brand-purple/15 rounded-full blur-[100px]" />
        <div className="absolute top-1/3 right-1/4 w-[300px] h-[300px] bg-brand-cyan/10 rounded-full blur-[80px]" />
        {/* Grid pattern */}
        <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-blue/10 border border-brand-blue/30 text-brand-cyan text-sm font-medium mb-8 animate-fade-in">
        ...
        <p className="text-xl sm:text-2xl text-brand-text max-w-3xl mx-auto mb-4 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
        ...
        <p className="text-base text-brand-text/70 max-w-2xl mx-auto mb-10 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
          ...
          <a
            href="#features"
            className="px-8 py-4 rounded-xl text-base font-semibold text-brand-text border border-brand-border hover:border-brand-blue/50 hover:text-brand-heading transition-all duration-300 w-full sm:w-auto"
          >
            See How It Works
          </a>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 mb-16">
          ...
          <div className="grid grid-cols-2 gap-6 text-left">
            {[
              ...
              <div
                key={i}
                className="p-4 rounded-xl bg-brand-card/50 border border-brand-border backdrop-blur-sm"
              >
                <div className="text-3xl font-black gradient-text mb-1">{stat.value}</div>
                <div className="text-sm font-semibold text-brand-heading">{stat.label}</div>
        ...
        <div className="relative overflow-hidden py-4">
          <div className="absolute left-0 top-0 bottom-0 w-20 bg-gradient-to-r from-brand-darker to-transparent z-10" />
          <div className="absolute right-0 top-0 bottom-0 w-20 bg-gradient-to-l from-brand-darker to-transparent z-10" />
          <div
            ref={tickerRef}
            className="flex gap-8 animate-ticker whitespace-nowrap"
          >
            {PROP_FIRMS.map((firm, i) => (
              <span key={i} className="text-sm text-brand-text/50 font-medium flex-shrink-0">
                {firm}
              </span>
            ))}
          </div>
